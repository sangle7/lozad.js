...
var toastr_min$1 = createCommonjsModule(function (module) {
  !function (e) {
    e(["jquery"], function (e) {
      return function () {
        function t(e, t, n) {
          ...
          var i = m();v || n(i), l(e, i, t) || d(i);
        }function c(t) {
          var i = m();return v || n(i), t && 0 === e(":focus", t).length ? void h(t) : void (v.children().length && v.remove());
        }function d(t) {
          for (var n = v.children(), i = n.length - 1; i >= 0; i--) {
            l(e(n[i]), t);
          }
        }function l(t, n, i) {
          var o = i && i.force ? i.force : !1;return t && (o || 0 === e(":focus", t).length) ? (t[n.hideMethod]({ duration: n.hideDuration, easing: n.hideEasing, complete: function complete() {
              h(t);
            } }), !0) : !1;
        }function u(t) {
          ...
          function i(e) {
            ...
            if (e.preventDuplicates) {
              if (t.message === C) return !0;C = t.message;
            }return !1;
          }function w(t) {
            var n = t && x.closeMethod !== !1 ? x.closeMethod : x.hideMethod,
                i = t && x.closeDuration !== !1 ? x.closeDuration : x.hideDuration,
                o = t && x.closeEasing !== !1 ? x.closeEasing : x.hideEasing;return !e(":focus", y).length || t ? (clearTimeout(q.intervalId), y[n]({ duration: i, easing: o, complete: function complete() {
            ...
            var e = (q.hideEta - new Date().getTime()) / q.maxHideTime * 100;B.width(e + "%");
          }var x = m(),
              E = t.iconClass || x.iconClass;if ("undefined" != typeof t.optionsOverride && (x = e.extend(x, t.optionsOverride), E = t.optionsOverride.iconClass || E), !g(x, t)) {
            T++, v = n(x, !0);var H = null,
                y = e("<div/>"),
                I = e("<div/>"),
                M = e("<div/>"),
                B = e("<div/>"),
                ...
                j = { toastId: T, state: "visible", startTime: new Date(), options: x, map: t };return o(), a(), s(), f(j), x.debug && console && console.log(j), y;
          }
        }function m() {
          ...
          v || (v = n()), e.is(":visible") || (e.remove(), e = null, 0 === v.children().length && (v.remove(), C = void 0));
            ...
            b = { clear: r, remove: c, error: t, getContainer: n, info: i, options: {}, subscribe: o, success: s, version: "2.1.2", warning: a };return b;
      }();
    });
  }("function" == typeof undefined && undefined.amd ? undefined : function (e, t) {
    "undefined" != 'object' && module.exports ? module.exports = t(jquery) : window.toastr = t(window.jQuery);
  });
...
toastr_min$1.options = {
  ...
  load: function load(el) {
    ...
    el.onload = function () {
      el.style.width = "100%";
      toastr_min$1["success"]("Image " + el.dataset.index + " lazy loaded.");
    };
  }
});
